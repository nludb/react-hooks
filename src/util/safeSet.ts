...
import { resolveHookState, IHookStateSetAction  } from './resolveHookState';

const safeSet = <T>(newState: IHookStateSetAction<T|null>, getter: () => T|null, setter: (t:T|null) => void) => {
  /*
